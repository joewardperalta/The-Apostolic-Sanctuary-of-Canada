            ...
            <div className="flex justify-between gap-10 items-center">
              <div className="lg:w-full lg:max-w-[40rem]">
                ...
                <p className="text-[#333]">
                  To Carry out the Commission of our Lord Jesus Christ; to
                  preach, teach and make disciples; to serve and help our
                  communities through various ministries and programs; to be the
                  modern day disciples and apostles of our Lord Jesus Christ to
                  carry the Gospel to all nations and people.
                </p>
              </div>
            ...
            <div className="flex justify-between gap-10 items-center">
              <div className="lg:w-full lg:max-w-[40rem]">
                ...
                <p className="text-[#333]">
                  ...
                  preserve the principles and truths of the Bible; to adopt
                  those principles and truths into our daily lives.
                </p>
                <p className="text-[#333]">
                  We commit to be a hospitable body of Jesus Christ. We do not
                  tolerate racism, sexism, any form of bullying, hatred, abuse
                  of authority, pride and the sins that beset the Church, of
                  which God hates. We endeavour to maintain the unity, forgiving
                  one another and to love and serve one another in the goal of
                  being faithful, unified body of Christ. We commit to these
                  virtues to be able to reach and minister in our communities.
                  We accept all people regardless of background, ethnicity, or
                  sexual orientation for the sake of the Gospel to reach them
                  and minister with the love of God.
                </p>
              </div>
            ...
            <div className="flex justify-between gap-10 items-center">
              <div className="lg:w-full lg:max-w-[40rem]">
                ...
                <p className="text-[#333]">
                  ...
                  according to the Canada Charter of Rights and Freedoms -
                  Section 2(a), as well as the Bylaws set forth by our Church.
                  We at all costs, hold to these rights and privileges.
                </p>
              </div>
